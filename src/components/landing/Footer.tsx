...
const footerLinks = {
  ...
  Resources: ["Documentation", "Guides", "Templates", "Community", "Partners"],
...
export default function Footer() {
  return (
    <footer className="relative border-t border-white/[0.04] bg-[#050507]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-gray-500 leading-relaxed mb-6 max-w-xs">
              AI-powered collaboration platform for teams that ship fast.
            </p>
            <div className="flex gap-2">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="w-8 h-8 rounded-lg glass flex items-center justify-center text-gray-500 hover:text-white hover:bg-white/[0.08] transition-all"
